...
namespace gmdlib::err
{
    ...
    constexpr char BITMAP_BIN_SIZE_LIMIT_EXCEEDED[]{"Bitmap binary m_size limit exceeded"};
    ...
    constexpr char WIDTH_OR_HEIGHT_EQ_0[]{"m_width/m_height equals 0"};
    constexpr char IMG_WIDTH_OR_HEIGHT_LIMIT_EXCEEDED[]{"image m_width/m_height limit exceeded"};
    constexpr char COLOR_PALETTE_NOT_ASSIGNED[]{"Color m_palette is not assigned"};
    constexpr char COLOR_PALETTE_INCOMPATIBLE[]{
            "Color m_palette is incompatible (different count of m_colors than expected)"};
